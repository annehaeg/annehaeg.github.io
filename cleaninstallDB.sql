...
(42, 1, 6, 'Description-Abstract', 'Samenvatting van de bron.', NULL),
(43, 1, 7, 'Creator', 'De auteur', NULL),
(44, 1, 8, 'Contributor', 'Co-auteur(s), illustrator, ontwerper, vertaler, redacteur, voorwoord ... ', NULL),
(45, 1, 9, 'Publisher', 'De uitgever/ Lettergieterij van de bron', NULL),
(46, 1, 10, 'Coverage-Spatial-Publisher', 'De locatie van de uitgever/lettergieterij die de bron uitgegeven heeft.', NULL),
(47, 1, 11, 'Date', 'Datum van de creatie van de bron', NULL),
(48, 1, 12, 'Periode', 'De periode waarin de bron ontstaan in. ', NULL),
(49, 1, 13, 'Coverage-Spatial', 'De locatie van de bron, waar de bron gecreëerd is.', NULL),
(50, 1, 14, 'Stijl', 'De stijl waarin de bron gemaakt is. ( Bijvoorbeeld Art deco)', NULL),
(51, 1, 15, 'Genre-Drukwerk', 'Genre van het drukwerk. Komt overeen met collectie waarin de bron zich bevindt. ', NULL),
(52, 1, 16, 'Documentsoort', 'Bijvoorbeeld \"enveloppe\"', NULL),
(53, 1, 17, 'Toepassing', 'Bijvoorbeeld bidprent, devotieprent, spijskaart, adreskaart, publiciteitskaars, kalender ... ', NULL),
(54, 1, 18, 'Druktechniek', 'De gebruikte druktechniek', NULL),
(55, 1, 19, 'Veredeling-Druk ', 'De gebruikte veredeling', NULL),
(56, 1, 20, 'Veredeling-Inkt', 'De gebruikte veredeling van de inkt', NULL),
(57, 1, 21, 'Kleur', 'Zal in de meeste gevallen \'kleur\' of \'zwart-wit\' zijn', NULL),
(58, 1, 22, 'Format-Medium', 'Materiaal waaruit de bron vervaardigd is', NULL),
(59, 1, 23, 'Watermerk', 'Watermerk dat zich op de bron bevindt', NULL),
(60, 1, 24, 'Vorm', 'Bijvoorbeeld met uitvouw, montage/collage, losbladig, folder... ', NULL),
(61, 1, 25, 'Keerzijde-druk', 'Gedrukte gegevens die zich op de keerzijde van de bron bevinden', NULL),
(62, 1, 26, 'Keerzijde-schrift', 'Handgeschreven notitie op de keerzijde van de bron', NULL),
(63, 1, 27, 'Keerzijde-stempel', 'Stempel op de keerzijde van de bron', NULL),
(64, 1, 28, 'Catalogusnummer-Uitgever', 'Catalogusnummer van de uitgever van de bron', NULL),
(65, 1, 29, 'Varia', 'Varia', NULL),
(66, 1, 30, 'Classificaties', 'Classificaties van de bron, waaronder typografische info.', NULL),
(67, 1, 31, 'Language', 'De taal van de bron', NULL),
(68, 1, 32, 'Rights', 'Informatie over de rechten van de bron', NULL),
(69, 1, 33, 'Type', 'Komt overeen met ItemType (still image, video, text ...)', NULL),
(70, 1, 34, 'Onderdelen', 'Verschillende onderdelen van de bron.', NULL),
(71, 1, 35, 'Schade', 'De schade die de bron heeft.', NULL),
(72, 1, 36, 'Format-Extent', 'Afmetingen van de bron. Komt overeen met PhysicalDimension', NULL),
(73, 1, 37, 'Bewaarplaats', 'Waar de bron te vinden is.', NULL),
(74, 1, 38, 'Fonds', 'Fonds', NULL),
(75, 1, 39, 'Provenance', 'Door wie de bron geschonken is.', NULL),
(76, 1, 40, 'Geschiedenis', 'Vroegere ID of vroegere bewaarplaats van de bron', NULL);
